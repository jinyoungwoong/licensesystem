...
namespace KWorks.License.Setting.Program
{
    ...
    {
        public static string ConnectionString = "Server=127.0.0.1; Port=5432; User Id=postgres; Password=KSolution*@82; Database=postgres";
    }
    ...
    public class SqlHelper
    {
        ...
        #region ExecuteNonQuery - Extend
        /// <summary>
        /// ExecuteNonQuery(확장)
        /// </summary>
        /// <param name="connectionString">데이터베이스 연결 문자열</param>
        /// <param name="commandText">쿼리 문자열 배열</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="connectionString">데이터베이스 연결 문자열</param>
        /// <param name="commandText">쿼리 문자열 ArrayList</param>
        /// <returns></returns>
        public static int ExecuteNonQuery(string connectionString, ArrayList commandText)
        {
            string[] sql = new string[commandText.Count];

            for (int i = 0; i < sql.Length; i++)
            {
                sql[i] = Convert.ToString(commandText[i]);
            }
        ...
        public static bool SettingConnectDb(string val)
        {
            using (var conn = new MySqlConnection(val + ";Pooling=False"))
            {
                try
                {
                    conn.Open();
